...
import { createAuthor, getAllAuthors, getAuthor, deleteAuthor, updateAuthor } from "../models/authorModel";


const authorsGet = (req: Request, res: Response<Author[]>, next: NextFunction) => {
  try {
